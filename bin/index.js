...
const commentOnCommit = (comment, token) => __awaiter(void 0, void 0, void 0, function* () {
    const inputs = {
        token,
        body: comment
    };
